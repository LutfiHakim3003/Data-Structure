public class Praktikum09_LinkedList3 {
    Node head;
    class Node {
        int data;
        Node next;
    ...
    public Node findNode(int data1) {
        Node hasil = null;
        Node sekarang = head;
        while (sekarang.data != data1) {
    ...
    public static void main(String[] args) {
        Praktikum09_LinkedList3 llist = new Praktikum09_LinkedList3();
