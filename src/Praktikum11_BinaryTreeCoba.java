public class Praktikum11_BinaryTreeCoba {
    // first node
    private Node root;
    Praktikum11_BinaryTreeCoba() {
        root = null;
    }
    ...
    public static void main(String[] args) {
        Praktikum11_BinaryTreeCoba bst = new Praktikum11_BinaryTreeCoba();
        bst.insert(34);
        bst.insert(56);
        bst.insert(12);
        bst.insert(89);
